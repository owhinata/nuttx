/****************************************************************************
 * arch/arm/src/stm32/hardware/stm32f413xx_pinmap_legacy.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32_HARDWARE_STM32F413XX_PINMAP_LEGACY_H
#define __ARCH_ARM_SRC_STM32_HARDWARE_STM32F413XX_PINMAP_LEGACY_H
...
#define GPIO_UART8_RX_0   (GPIO_ALT | GPIO_AF8 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTE | GPIO_PIN0)
#define GPIO_UART8_TX_0   (GPIO_ALT | GPIO_AF8 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTE | GPIO_PIN1)

#define GPIO_UART9_RX_1   (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTD | GPIO_PIN14)
#define GPIO_UART9_RX_2   (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTG | GPIO_PIN0)
#define GPIO_UART9_TX_1   (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTD | GPIO_PIN15)
#define GPIO_UART9_TX_2   (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTG | GPIO_PIN1)

#define GPIO_UART10_RX_1  (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTE | GPIO_PIN2)
#define GPIO_UART10_RX_2  (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTG | GPIO_PIN11)
#define GPIO_UART10_TX_1  (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTE | GPIO_PIN3)
#define GPIO_UART10_TX_2  (GPIO_ALT | GPIO_AF11 | GPIO_PULLUP | GPIO_SPEED_100MHz | GPIO_PUSHPULL | GPIO_PORTG | GPIO_PIN12)
...
#endif /* __ARCH_ARM_SRC_STM32_HARDWARE_STM32F413XX_PINMAP_LEGACY_H */
