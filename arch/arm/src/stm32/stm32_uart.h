...
#if STM32_NUSART < 10 || !defined(CONFIG_STM32_HAVE_UART10)
#  undef CONFIG_STM32_UART10
#endif
#if STM32_NUSART < 9 || !defined(CONFIG_STM32_HAVE_UART9)
#  undef CONFIG_STM32_UART9
#endif
...
#endif
#if !defined(CONFIG_STM32_UART10)
#  undef CONFIG_STM32_UART10_SERIALDRIVER
#  undef CONFIG_STM32_UART10_1WIREDRIVER
#endif
...
#  undef CONFIG_STM32_UART8_1WIREDRIVER
#endif
#if defined(CONFIG_STM32_UART9_1WIREDRIVER) && defined(CONFIG_STM32_UART9_SERIALDRIVER)
#  error Both CONFIG_STM32_UART9_1WIREDRIVER and CONFIG_STM32_UART9_SERIALDRIVER defined
#  undef CONFIG_STM32_UART9_1WIREDRIVER
#endif
#if defined(CONFIG_STM32_UART10_1WIREDRIVER) && defined(CONFIG_STM32_UART10_SERIALDRIVER)
#  error Both CONFIG_STM32_UART10_1WIREDRIVER and CONFIG_STM32_UART10_SERIALDRIVER defined
#  undef CONFIG_STM32_UART10_1WIREDRIVER
#endif
...
/* Is the serial driver enabled? */
    ...
    defined(CONFIG_STM32_UART9_SERIALDRIVER)  || defined(CONFIG_STM32_UART10_SERIALDRIVER) || \
...
/* Is the 1-Wire driver? */
    ...
    defined(CONFIG_STM32_UART9_1WIREDRIVER) || defined(CONFIG_STM32_UART10_1WIREDRIVER)
...
#  undef CONFIG_UART10_SERIAL_CONSOLE
...
#  define CONSOLE_LPUART 0
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_UART10_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART10_SERIALDRIVER)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
...
#ifndef CONFIG_STM32_UART10_SERIALDRIVER
#  undef CONFIG_UART10_RXDMA
#  undef CONFIG_UART10_TXDMA
#endif
...
#  define SERIAL_HAVE_CONSOLE_RXDMA 1
#elif defined(CONFIG_UART10_SERIAL_CONSOLE) && defined(CONFIG_UART10_RXDMA)
#  define SERIAL_HAVE_CONSOLE_RXDMA 1
...
#  define SERIAL_HAVE_CONSOLE_TXDMA 1
#elif defined(CONFIG_UART9_SERIAL_CONSOLE) && defined(CONFIG_UART9_TXDMA)
#  define SERIAL_HAVE_CONSOLE_TXDMA 1
#elif defined(CONFIG_UART10_SERIAL_CONSOLE) && defined(CONFIG_UART10_TXDMA)
#  define SERIAL_HAVE_CONSOLE_TXDMA 1
...
#  undef SERIAL_HAVE_ONLY_RXDMA
#elif defined(CONFIG_STM32_UART9) && !defined(CONFIG_UART9_RXDMA)
#  undef SERIAL_HAVE_ONLY_RXDMA
#elif defined(CONFIG_STM32_UART10) && !defined(CONFIG_UART10_RXDMA)
#  undef SERIAL_HAVE_ONLY_RXDMA
...
#  undef SERIAL_HAVE_ONLY_TXDMA
#elif defined(CONFIG_STM32_UART9) && !defined(CONFIG_UART9_TXDMA)
#  undef SERIAL_HAVE_ONLY_TXDMA
#elif defined(CONFIG_STM32_UART10) && !defined(CONFIG_UART10_TXDMA)
#  undef SERIAL_HAVE_ONLY_TXDMA
...
#  define SERIAL_HAVE_NODMA_OPS
#elif defined(CONFIG_STM32_UART9) && !defined(CONFIG_UART9_RXDMA) &&  \
    !defined(CONFIG_UART9_TXDMA)
#  define SERIAL_HAVE_NODMA_OPS
#elif defined(CONFIG_STM32_UART10) && !defined(CONFIG_UART10_RXDMA) &&  \
    !defined(CONFIG_UART10_TXDMA)
#  define SERIAL_HAVE_NODMA_OPS
#elif defined(CONFIG_STM32_LPUART1) && !defined(CONFIG_LPUART1_RXDMA) &&  \
    !defined(CONFIG_LPUART1_TXDMA)
#  define SERIAL_HAVE_NODMA_OPS
...
/* Is RS-485 used? */
    ...
    defined(CONFIG_UART9_RS485)  || defined(CONFIG_UART10_RS485) || \
