/****************************************************************************
 * arch/arm/src/stm32l4/hardware/stm32l4_octospi.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32L4_HARDWARE_STM32L4_OCTOSPI_H
#define __ARCH_ARM_SRC_STM32L4_HARDWARE_STM32L4_OCTOSPI_H
...
#define STM32L4_OCTOSPI_MINBITS          8         /* Minimum word width */
#define STM32L4_OCTOSPI_MAXBITS          32        /* Maximum word width */
...
#define STM32_OCTOSPI_CR     (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_CR_OFFSET)     /* Control Register */
#define STM32_OCTOSPI_DCR1   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DCR1_OFFSET)   /* Device Configuration Register 1 */
#define STM32_OCTOSPI_DCR2   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DCR2_OFFSET)   /* Device Configuration Register 2 */
#define STM32_OCTOSPI_DCR3   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DCR3_OFFSET)   /* Device Configuration Register 3 */
#define STM32_OCTOSPI_DCR4   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DCR4_OFFSET)   /* Device Configuration Register 4 */
#define STM32_OCTOSPI_SR     (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_SR_OFFSET)     /* Status Register */
#define STM32_OCTOSPI_FCR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_FCR_OFFSET)    /* Flag Clear Register */
#define STM32_OCTOSPI_DLR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DLR_OFFSET)    /* Data Length Register */
#define STM32_OCTOSPI_AR     (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_AR_OFFSET)     /* Address Register */
#define STM32_OCTOSPI_DR     (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_DR_OFFSET)     /* Data Register */
#define STM32_OCTOSPI_PSMKR  (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_PSMKR_OFFSET)  /* Polling Status mask Register */
#define STM32_OCTOSPI_PSMAR  (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_PSMAR_OFFSET)  /* Polling Status match Register */
#define STM32_OCTOSPI_PIR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_PIR_OFFSET)    /* Polling Interval Register */
#define STM32_OCTOSPI_CCR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_CCR_OFFSET)    /* Communication Configuration Register */
#define STM32_OCTOSPI_TCR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_TCR_OFFSET)    /* Timing Configuration Register */
#define STM32_OCTOSPI_IR     (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_IR_OFFSET)     /* Instruction Register */
#define STM32_OCTOSPI_ABR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_ABR_OFFSET)    /* Alternate Bytes Register */
#define STM32_OCTOSPI_LPTR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_LPTR_OFFSET)   /* Low-Power Timeout Register */
#define STM32_OCTOSPI_WPCCR  (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WPCCR_OFFSET)  /* Wrap Communication Configuration Register */
#define STM32_OCTOSPI_WPTCR  (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WPTCR_OFFSET)  /* Wrap Timing Configuration Register */
#define STM32_OCTOSPI_WPIR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WPIR_OFFSET)   /* Wrap Instruction Register */
#define STM32_OCTOSPI_WPABR  (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WPABR_OFFSET)  /* Wrap Alternate Bytes Register */
#define STM32_OCTOSPI_WCCR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WCCR_OFFSET)   /* Write Communication Configuration Register */
#define STM32_OCTOSPI_WTCR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WTCR_OFFSET)   /* Write Configuration Register */
#define STM32_OCTOSPI_WIR    (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WIR_OFFSET)    /* Write Instruction Register */
#define STM32_OCTOSPI_WABR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_WABR_OFFSET)   /* Write Alternate Bytes Register */
#define STM32_OCTOSPI_HLCR   (STM32L4_OCTOSPI1_BASE+STM32_OCTOSPI_HLCR_OFFSET)   /* HyperBus Latency Configuration Register */
...
#define OCTOSPI_DCR2_PRESCALER_MASK     (0xff << OCTOSPI_DCR2_PRESCALER_SHIFT)

#define OCTOSPI_DCR2_WRAPSIZE_SHIFT    (16)                              /* Bits 16-18: Wrap Size */
#define OCTOSPI_DCR2_WRAPSIZE_MASK     (0x7 << OCTOSPI_DCR2_WRAPSIZE_SHIFT)
#define OCTOSPI_DCR2_WRAPSIZE_DIS      (0x0 << OCTOSPI_DCR2_WRAPSIZE_SHIFT) /* Wrapped reads not supported */
#define OCTOSPI_DCR2_WRAPSIZE_16B      (0x2 << OCTOSPI_DCR2_WRAPSIZE_SHIFT) /* Wrap Size 16 bytes */
#define OCTOSPI_DCR2_WRAPSIZE_32B      (0x3 << OCTOSPI_DCR2_WRAPSIZE_SHIFT) /* Wrap Size 32 bytes */
#define OCTOSPI_DCR2_WRAPSIZE_64B      (0x4 << OCTOSPI_DCR2_WRAPSIZE_SHIFT) /* Wrap Size 64 bytes */
#define OCTOSPI_DCR2_WRAPSIZE_128B     (0x5 << OCTOSPI_DCR2_WRAPSIZE_SHIFT) /* Wrap Size 128 bytes */

/* Device Configuration Register 3 */

#define OCTOSPI_DCR3_CSBOUND_SHIFT    (16)       /* Bits 16-20: Clock prescaler */
#define OCTOSPI_DCR3_CSBOUND_MASK     (0x1f << OCTOSPI_DCR3_CSBOUND_SHIFT)
#define OCTOSPI_DCR3_CSBOUND(n)       ((n << OCTOSPI_DCR3_CSBOUND_SHIFT) & OCTOSPI_DCR3_CSBOUND_MASK) /* NCS boundary = 2^n bytes when n = 1-31 */
...
#define OCTOSPI_CCR_ADDTR             (1 << 11)   /* Bit 11: Address double transfer rate */
...
#endif /* __ARCH_ARM_SRC_STM32L4_HARDWARE_STM32L4_OCTOSPI_H */
